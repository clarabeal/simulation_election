...
public class AffichageHist{
    ...
    private static JFreeChart getHistogramChart(String name, double[] dataArray){
        ...
        for (int i = 0; i < dataArray.length; i++){
            dataSet.addValue(dataArray[i], "Candidat "+i, (Integer) i);
        }
        boolean show = true;
        boolean toolTips = false;
        boolean urls = false;
        JFreeChart chart = ChartFactory.createBarChart(plotTitle, xAxisLabel,yAxis, dataSet, orientation, show, toolTips, urls);
